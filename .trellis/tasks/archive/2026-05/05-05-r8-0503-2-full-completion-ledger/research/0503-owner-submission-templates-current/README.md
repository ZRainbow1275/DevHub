# 0503 Owner Submission Templates

This directory contains owner submission template JSON files for the remaining 0503 owner actions.

Directory command output schema: `devhub-0503-owner-submission-template-directory-v1`.
